...
{
    public class RowSelectorPrefix : SelectorPrefix
    {
        public RowSelectorPrefix(string constructor, string xpathPrefix)
        {
            this.Constructor = constructor;
            this.XpathPrefix = xpathPrefix;
        }

        public RowSelectorPrefix(string constructor, List<Func<string, IEnumerable<string>>> sequencedRowPrefixesByOrder)
        {
            this.Constructor = constructor;
